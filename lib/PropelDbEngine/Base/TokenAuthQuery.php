 ...
 * @method     ChildTokenAuthQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 *
 ...
 * @method     ChildTokenAuthQuery groupByUserId() Group by the user_id column
 *
 ...
 *
 * @method     ChildTokenAuthQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method     ChildTokenAuthQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method     ChildTokenAuthQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
 * @method     ChildTokenAuthQuery joinWithUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the User relation
 *
 * @method     ChildTokenAuthQuery leftJoinWithUser() Adds a LEFT JOIN clause and with to the query using the User relation
 * @method     ChildTokenAuthQuery rightJoinWithUser() Adds a RIGHT JOIN clause and with to the query using the User relation
 * @method     ChildTokenAuthQuery innerJoinWithUser() Adds a INNER JOIN clause and with to the query using the User relation
 *
 ...
 * @method     ChildTokenAuth|null findOneByUserId(int $user_id) Return the first ChildTokenAuth filtered by the user_id column *
 ...
 * @method     ChildTokenAuth requireOneByUserId(int $user_id) Return the first ChildTokenAuth filtered by the user_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildTokenAuth[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildTokenAuth objects based on current ModelCriteria
 * @method     ChildTokenAuth[]|ObjectCollection findById(int $id) Return ChildTokenAuth objects filtered by the id column
 * @method     ChildTokenAuth[]|ObjectCollection findByCookieHash(string $cookie_hash) Return ChildTokenAuth objects filtered by the cookie_hash column
 * @method     ChildTokenAuth[]|ObjectCollection findByExpires(string $expires) Return ChildTokenAuth objects filtered by the expires column
 * @method     ChildTokenAuth[]|ObjectCollection findByUserId(int $user_id) Return ChildTokenAuth objects filtered by the user_id column
...
abstract class TokenAuthQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Sbehnfeldt\Webapp\PropelDbEngine\Base\TokenAuthQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'webapp', $modelName = '\\Sbehnfeldt\\Webapp\\PropelDbEngine\\TokenAuth', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, cookie_hash, expires, user_id FROM token_auths WHERE id = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildTokenAuthQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(TokenAuthTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(TokenAuthTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TokenAuthTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByCookieHash($cookieHash = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TokenAuthTableMap::COL_COOKIE_HASH, $cookieHash, $comparison);
    }
    ...
    public function filterByExpires($expires = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TokenAuthTableMap::COL_EXPIRES, $expires, $comparison);
    }
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(TokenAuthTableMap::COL_USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(TokenAuthTableMap::COL_USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TokenAuthTableMap::COL_USER_ID, $userId, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildTokenAuthQuery The current query, for fluid interface
     */
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \Sbehnfeldt\Webapp\PropelDbEngine\User) {
            return $this
                ->addUsingAlias(TokenAuthTableMap::COL_USER_ID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(TokenAuthTableMap::COL_USER_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
