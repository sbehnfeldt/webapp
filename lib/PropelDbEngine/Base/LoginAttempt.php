...
abstract class LoginAttempt implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Sbehnfeldt\\Webapp\\PropelDbEngine\\Map\\LoginAttemptTableMap';
    ...
    /**
     * Initializes internal state of Sbehnfeldt\Webapp\PropelDbEngine\Base\LoginAttempt object.
     * @see applyDefaults()
     */
     ...
     */
    public function getAttemptedAt($format = null)
    {
        if ($format === null) {
            return $this->attempted_at;
        } else {
            return $this->attempted_at instanceof \DateTimeInterface ? $this->attempted_at->format($format) : null;
        }
    }
    ...
    public function setUsername($v)
    {
        ...
        if ($this->username !== $v) {
            $this->username = $v;
            $this->modifiedColumns[LoginAttemptTableMap::COL_USERNAME] = true;
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Sbehnfeldt\Webapp\PropelDbEngine\LoginAttempt
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Sbehnfeldt\Webapp\PropelDbEngine\LoginAttempt The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Sbehnfeldt\Webapp\PropelDbEngine\LoginAttempt (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Sbehnfeldt\Webapp\PropelDbEngine\LoginAttempt Clone of current object.
     * @throws PropelException
     */
