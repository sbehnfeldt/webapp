...
use Sbehnfeldt\Webapp\PropelDbEngine\Group;
...
class GroupTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Sbehnfeldt\\Webapp\\PropelDbEngine\\Group';
     ...
     */
    const COL_GROUPNAME = 'groups.groupname';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Groupname', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'groupname', 'description', ),
        self::TYPE_COLNAME       => array(GroupTableMap::COL_ID, GroupTableMap::COL_GROUPNAME, GroupTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'groupname', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Groupname' => 1, 'Description' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'groupname' => 1, 'description' => 2, ),
        self::TYPE_COLNAME       => array(GroupTableMap::COL_ID => 0, GroupTableMap::COL_GROUPNAME => 1, GroupTableMap::COL_DESCRIPTION => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'groupname' => 1, 'description' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'groupname' => 'GROUPNAME',
        'group.groupname' => 'GROUPNAME',
        'GroupTableMap::COL_GROUPNAME' => 'GROUPNAME',
        ...
        'description' => 'DESCRIPTION',
        'group.description' => 'DESCRIPTION',
        'GroupTableMap::COL_DESCRIPTION' => 'DESCRIPTION',
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Sbehnfeldt\\Webapp\\PropelDbEngine\\Group');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('groupname', 'Groupname', 'VARCHAR', true, 63, null);
    ...
    {
        $this->addRelation('GroupMemberRelatedByGroupId', '\\Sbehnfeldt\\Webapp\\PropelDbEngine\\GroupMember', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':group_id',
    1 => ':id',
  ),
), 'CASCADE', 'NO ACTION', 'GroupMembersRelatedByGroupId', false);
        $this->addRelation('GroupMemberRelatedByUserId', '\\Sbehnfeldt\\Webapp\\PropelDbEngine\\GroupMember', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ),
), 'CASCADE', 'NO ACTION', 'GroupMembersRelatedByUserId', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupTableMap::COL_GROUPNAME);
    ...
    public static function removeSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(GroupTableMap::COL_GROUPNAME);
            $criteria->removeSelectColumn(GroupTableMap::COL_DESCRIPTION);
        } else {
            $criteria->removeSelectColumn($alias . '.id');
            $criteria->removeSelectColumn($alias . '.groupname');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Sbehnfeldt\Webapp\PropelDbEngine\Group) { // it's a model object
